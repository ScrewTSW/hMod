Run server_nogui.bat and the mod will automatically download the latest server from minecraft.net.
DO NOT RUN Minecraft_Server.jar. DO NOT. IT WILL NOT WORK.
